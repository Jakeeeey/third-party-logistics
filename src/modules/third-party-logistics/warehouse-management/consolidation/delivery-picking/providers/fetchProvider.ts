...
export const fetchActiveBranches = async (): Promise<BranchDto[] | null> => {
    try {
        const url = `/api/third-party-logistics/warehouse-management/consolidation/branches?_t=${Date.now()}`;
...
export const fetchConsolidators = async (
    ...
    try {
        ...
        const url = `/api/third-party-logistics/warehouse-management/consolidation/delivery-picking?${queryParams.toString()}`;
...
export const fetchConsolidatorSummary = async (branchId?: number): Promise<Record<string, number> | null> => {
    try {
        ...
        const url = `/api/third-party-logistics/warehouse-management/consolidation/delivery-picking/summary?${queryParams.toString()}`;
        const response = await fetch(url, {
            headers: getHeaders(),
            cache: "no-store"
        });
...
export async function fetchPickersBySupplier(supplierId: number) {
    try {
        const res = await fetch(`/api/third-party-logistics/warehouse-management/consolidation/delivery-picking/pickers/suppliers/${supplierId}`, {
            headers: getHeaders()
        });
        if (!res.ok) return [];
...
export async function assignPicker(userId: number, supplierId: number) {
    try {
        const res = await fetch(`/api/third-party-logistics/warehouse-management/consolidation/delivery-picking/pickers/assign`, {
            method: "POST",
            headers: getHeaders(),
...
export async function unassignPicker(userId: number, supplierId: number) {
    try {
        const res = await fetch(`/api/third-party-logistics/warehouse-management/consolidation/delivery-picking/pickers/unassign`, {
            method: "POST",
            headers: getHeaders(),
            body: JSON.stringify({ userId, supplierId })
        });
...
export async function fetchAllActiveSuppliers(supplierType?: string) {
    try {
        ...
        const url = `/api/third-party-logistics/warehouse-management/consolidation/delivery-picking/pickers/suppliers?${params.toString()}`;
...
export async function fetchAllUsers(departmentId?: number) {
    try {
        ...
        const url = `/api/third-party-logistics/warehouse-management/consolidation/delivery-picking/pickers/users?${params.toString()}`;
        const res = await fetch(url, { headers: getHeaders() });
        if (!res.ok) return [];
        const data = await res.json();
        return Array.isArray(data) ? data : [];
...
export const fetchDispatchPlans = async (branchId?: number | string): Promise<unknown[]> => {
    try {
        ...
        const url = `/api/third-party-logistics/warehouse-management/consolidation/dispatch-plans?${params.toString()}`;
        const res = await fetch(url, { headers: getHeaders() });
        if (!res.ok) return [];
        const data = await res.json();
...
export const fetchConsolidationPreview = async (dispatchIds: number[]): Promise<ConsolidationPreviewItem[]> => {
    try {
        ...
        const url = `/api/third-party-logistics/warehouse-management/consolidation/preview?${params.toString()}`;
        const res = await fetch(url, { headers: getHeaders() });
...
export const generateConsolidationBatch = async (dispatchIds: number[]): Promise<ConsolidatorDto | null> => {
    try {
        const url = `/api/third-party-logistics/warehouse-management/consolidation/create-batch`;
...
export const startPickingBatch = async (consolidatorNo: string, checkerId: number): Promise<boolean> => {
    try {
        const url = `/api/third-party-logistics/warehouse-management/consolidation/delivery-picking/start`;
        const response = await fetch(url, {
            method: "POST",
            headers: getHeaders(),
...
export const transmitItemScan = async (payload: {
    ...
    try {
        const url = `/api/third-party-logistics/warehouse-management/consolidation/picking/scan`;
        const response = await fetch(url, {
            method: "POST",
            headers: getHeaders(),
