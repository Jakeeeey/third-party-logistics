...
} from "@/modules/third-party-logistics/warehouse-management/consolidation/delivery-picking/providers/fetchProvider";
import { ConsolidatorDto as DeliveryConsolidatorDto } from "@/modules/third-party-logistics/warehouse-management/consolidation/delivery-picking/types";
...
export const fetchActiveBranches = async (): Promise<BranchDto[]> => {
    try {
        const url = new URL("/api/third-party-logistics/warehouse-management/consolidation/branches", window.location.origin);
...
export const fetchActivePickingBatches = async (
    ...
    try {
        const url = new URL("/api/third-party-logistics/warehouse-management/consolidation/delivery-picking", window.location.origin);
...
export async function submitManualPick(payload: {
    ...
    const res = await fetch("/api/third-party-logistics/warehouse-management/consolidation/picking/manual", {
        method: "POST",
        headers: HEADERS,
...
export const lookupRfidTag = async (rfidTag: string): Promise<number | null> => {
    try {
        const url = new URL("/api/third-party-logistics/warehouse-management/consolidation/picking/lookup", window.location.origin);
...
export const completePickingBatch = async (batchId: number): Promise<boolean> => {
    try {
        const url = "/api/third-party-logistics/warehouse-management/consolidation/picking/complete";
        const response = await fetch(url, {
            method: "POST",
            headers: HEADERS,
