...
import DispatchBudgetingPage from "@/modules/third-party-logistics/fleet-management/trip-management/dispatch-plan/budgeting/DispatchBudgetingPage";
...
export default async function Page() {
  ...
  return (
    ...
    <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
      ...
      <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-2 sm:p-4 flex flex-col">
        <DispatchBudgetingPage />
      </main>
    </div>
  );
}
