...
import ManualPickerDashboardModule from "@/modules/third-party-logistics/warehouse-management/active-picking/components/ManualPickerDashboardModule";
...
function buildHeaderUserFromToken(token: string | null | undefined) {
    ...
    return { name, email: email || "No email provided", avatar: "/avatars/shadcn.jpg" };
}

export default async function ManualPickingPage() {
                ...
                <div className="flex items-center gap-2 px-4">
                    ...
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbItem className="hidden md:block">
                                <BreadcrumbLink href="/third-party-logistics/warehouse-management/active-picking/manual">Active Picking</BreadcrumbLink>
                            </BreadcrumbItem>
                            <BreadcrumbSeparator className="hidden md:block" />
                            <BreadcrumbItem>
                                <BreadcrumbPage>Manual Picking</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
