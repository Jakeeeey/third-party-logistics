...
import RFIDPickerDashboardModule from "@/modules/third-party-logistics/warehouse-management/active-picking/components/RFIDPickerDashboardModule";
...
export default async function RFIDPickingPage() {
                ...
                <div className="flex items-center gap-2 px-4">
                    ...
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbItem className="hidden md:block">
                                <BreadcrumbLink href="/third-party-logistics/warehouse-management/active-picking/rfid">Active Picking</BreadcrumbLink>
                            </BreadcrumbItem>
                            <BreadcrumbSeparator className="hidden md:block" />
                            <BreadcrumbItem>
                                <BreadcrumbPage>RFID Picking</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
