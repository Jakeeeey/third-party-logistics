...
import { OPSDashboardModule } from "@/modules/third-party-logistics/customer-hub/ops-dashboard";

export const dynamic = "force-dynamic";

const COOKIE_NAME = "vos_access_token";

// Helper to build header user (standard pattern in this project)
...
export default async function Page() {
    ...
    return (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
                        ...
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbItem className="min-w-0 overflow-hidden">
                                    <BreadcrumbPage className="truncate">Customer Map</BreadcrumbPage>
                                </BreadcrumbItem>
                            </BreadcrumbList>
                        </Breadcrumb>
                    </div>
            ...
            <main className="min-h-0 min-w-0 flex-1 overflow-hidden p-2 md:p-3">
                <OPSDashboardModule />
            </main>
        </div>
    );
