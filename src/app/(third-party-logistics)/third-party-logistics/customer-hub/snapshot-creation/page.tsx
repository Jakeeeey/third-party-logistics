...
import SnapshotCreationModule from "@/modules/third-party-logistics/customer-hub/snapshot-creation/SnapshotCreationModule";
...
export default async function Page() {
    ...
    return (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
            ...
            <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden bg-slate-50/50 p-4 md:p-8">
                <SnapshotCreationModule />
            </main>
        </div>
    );
}
