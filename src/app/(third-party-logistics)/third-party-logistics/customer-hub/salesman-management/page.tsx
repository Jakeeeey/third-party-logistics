...
import { SalesmanManagementModule } from "@/modules/third-party-logistics/customer-hub/salesman-management";
...
export default async function SalesmanManagementPage() {
